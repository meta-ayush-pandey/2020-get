...
public class SearchStudentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = String.format("select * from Student where name = '%s'",name);
		...
		try {
			...
			out.println("<tr><th>SN</th><th>Firstname</th><th>Lastname</th><th>fathername</th><th>email</th><th>class</th><th>Age</th></tr>");
			while (result.next()) {
			...
			response.getWriter().print("No entry found");
